    ...
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white font-bold'>
      ...
      <ul className='flex-1 text-right'>
        {insideHome && <li className='list-none inline-block px-5'> 
          <input style={{width:"300px"}} className='rounded p-1 text-black' type='text' onChange={e=>dispatch(searchProducts(e.target.value.toLowerCase()))} placeholder='Search Products'/></li>}
